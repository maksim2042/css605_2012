...
def playGame():
        ...
        pattern=[]
        generation=0
        while len(pattern)==0 and generation<200:
                genomeId=0
...
pType=input('Which type of T4T strategy do you want to employ? (random start=1, nonrandom start=2)')
